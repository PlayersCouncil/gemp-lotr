var CardGroup = Class.extend({
    ...
    init:function (container, belongTest, createDiv, existingDiv, locationIndex, bottomPlayerId) {
...
var VerticalBarGroup = CardGroup.extend({
    init:function (container, belongTest, createDiv, existingDiv, locationIndex, bottomPlayerId) {
        this._super(container, belongTest, createDiv, existingDiv, locationIndex, bottomPlayerId);
    },
