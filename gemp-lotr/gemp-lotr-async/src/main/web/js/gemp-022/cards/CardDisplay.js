...
class CardDisplay {
	...
	static FoilImage	= "/gemp-lotr/images/holo.jpg";
	static AnimatedFoilImage	= "/gemp-lotr/images/foil.gif";
	static GetFoilImage() {
		let foil = Card.getFoilPresentation();
		if(foil == "animated")
			return CardDisplay.AnimatedFoilImage;
		
		if(foil == "static")
			return CardDisplay.FoilImage;
		
		//none
		return CardDisplay.PixelOverlay;
	}
	static PixelOverlay = "/gemp-lotr/images/pixel.png";
