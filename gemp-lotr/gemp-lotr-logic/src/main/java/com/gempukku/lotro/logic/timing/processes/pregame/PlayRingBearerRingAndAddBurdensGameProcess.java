...
public class PlayRingBearerRingAndAddBurdensGameProcess implements GameProcess {
    private final Map<String, Integer> _bids;
    private final String _firstPlayer;

    public PlayRingBearerRingAndAddBurdensGameProcess(Map<String, Integer> bids, String firstPlayer) {
        _bids = bids;
