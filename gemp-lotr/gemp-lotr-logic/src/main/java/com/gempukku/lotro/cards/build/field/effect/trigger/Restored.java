...
public class Restored implements TriggerCheckerProducer {
    @Override
    public TriggerChecker getTriggerChecker(JSONObject value, CardGenerationEnvironment environment) throws InvalidCardDefinitionException {
        ...
        {
            throw new InvalidCardDefinitionException("'zone' using an unsupported zone in Restored trigger (omit the value if wanting to trigger from anywhere in play).");
        }
        ...
        return new TriggerChecker() {
            ...
            public boolean accepts(ActionContext actionContext) {
                ...
                if(TriggerConditions.forEachDiscardedFromPlay(actionContext.getGame(), actionContext.getEffectResult(), filterable)) {
                    ...
                    restoredCard = restoredResult.getRestoredCard();
                }
                ...
                if (memorize != null) {
                    actionContext.setCardMemory(memorize, restoredCard);
                }
                return true;
            }
        };
