...
public class EffectFieldProcessor implements FieldProcessor {
    ...
    public EffectFieldProcessor() {
        ...
        effectProcessors.put("deckbuildingoverride", new DeckBuildingOverrideGameTextProcessor());
        effectProcessors.put("selfremovedfromplaytrigger", new SelfRemovedFromPlayTriggerEffectProcessor());
