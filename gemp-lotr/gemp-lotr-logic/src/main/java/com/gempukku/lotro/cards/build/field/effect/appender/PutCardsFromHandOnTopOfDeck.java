...
public class PutCardsFromHandOnTopOfDeck implements EffectAppenderProducer {
    ...
    public EffectAppender createEffectAppender(JSONObject effectObject, CardGenerationEnvironment environment) throws InvalidCardDefinitionException {
        FieldUtils.validateAllowedFields(effectObject, "player", "hand", "filter", "count", "reveal");
        ...
        result.addEffectAppender(
                CardResolver.resolveCardsInHand(filter, count, "_temp", player, hand, "Choose cards from hand", true, environment));
        result.addEffectAppender(
                new DelayedAppender() {
                    @Override
