...
public class HasCardInDrawDeck implements RequirementProducer {
    @Override
    public Requirement getPlayRequirement(JSONObject object, CardGenerationEnvironment environment) throws InvalidCardDefinitionException {
        ...
        return (actionContext) -> {
            ...
            return Filters.filter(game, game.getGameState().getDeck(playerId), new Filterable[]{filterable}).size() >= count;
        };
    }
}
