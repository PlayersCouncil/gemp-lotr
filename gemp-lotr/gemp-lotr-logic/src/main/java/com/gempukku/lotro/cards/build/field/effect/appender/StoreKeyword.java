                ...
                return new UnrespondableEffect() {
                    ...
                    protected void doPlayEffect(LotroGame game) {
                        ...
                        if (valueFromMemory != null) {
                            Keyword keyword = Keyword.valueOf(valueFromMemory);
                            actionContext.getSource().setWhileInZoneData(new ReadableStringWhileInZoneData(keyword.name(), keyword.getHumanReadable()));
                        }
                    }
                };
            }
