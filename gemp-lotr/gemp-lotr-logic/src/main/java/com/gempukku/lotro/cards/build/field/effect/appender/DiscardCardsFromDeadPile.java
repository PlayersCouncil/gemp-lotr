...
import com.gempukku.lotro.logic.effects.DiscardCardsFromDeadPileEffect;
import com.gempukku.lotro.logic.timing.Effect;
import org.json.simple.JSONObject;

import java.util.Collection;

public class DiscardCardsFromDeadPile implements EffectAppenderProducer {
    @Override
        ...
        result.addEffectAppender(
                new DelayedAppender() {
                    ...
                    protected Effect createEffect(boolean cost, CostToEffectAction action, ActionContext actionContext) {
                        ...
                        return new DiscardCardsFromDeadPileEffect(actionContext.getSource(), player, cards);
                    }
                });
