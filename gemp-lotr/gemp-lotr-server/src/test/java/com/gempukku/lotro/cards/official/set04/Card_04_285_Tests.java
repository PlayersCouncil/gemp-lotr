...
public class Card_04_285_Tests
{
	...
	//@Test
	public void LodStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {

		/**
		* Set: 4
		* Title: Léod, Westfold Herdsman
		* Unique: True
		* Side: FREE_PEOPLE
		* Culture: Rohan
		* Twilight Cost: 1
	...
	//@Test
	public void LodTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
