...
public class Card_19_012_Tests
{
	...
	public void AragornStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		/**
		 * Set: 19
		 * Name: Aragorn, Well-traveled Guide
		 * Unique: True
		 * Side: Free Peoples
		 * Culture: Gondor
		 * Twilight Cost: 4
		 ...
		 * Vitality: 4
		 * Resistance: 8
		 * Game Text: <b>Fellowship</b>. <b>Ranger</b>.<br>While the Ring-bearer is the only other companion you can spot, Aragorn is an <b>archer</b>, <b>defender +1</b>, and can take no more than 1 wound each skirmish.
		*/
		...
		assertEquals("Well-traveled Guide", card.getBlueprint().getSubtitle());
