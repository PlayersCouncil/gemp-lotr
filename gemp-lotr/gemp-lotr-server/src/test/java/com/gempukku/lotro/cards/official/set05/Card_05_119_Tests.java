...
public class Card_05_119_Tests
{
	...
	//@Test
	public void NanCurunrStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
	...
	//@Test
	public void NanCurunrTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
