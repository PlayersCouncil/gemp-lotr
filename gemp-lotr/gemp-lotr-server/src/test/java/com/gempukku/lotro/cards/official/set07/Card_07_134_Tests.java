...
public class Card_07_134_Tests
{
	...
	@Test
	public void DesertScoutStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		assertEquals("Desert Scout", card.getBlueprint().getTitle());
	...
	//@Test
	public void DesertScoutTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
