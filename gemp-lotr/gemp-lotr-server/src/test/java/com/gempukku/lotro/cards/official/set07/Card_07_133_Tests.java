...
public class Card_07_133_Tests
{
	...
	@Test
	public void DesertRunnerStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		assertEquals("Desert Runner", card.getBlueprint().getTitle());
	...
	//@Test
	public void DesertRunnerTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
