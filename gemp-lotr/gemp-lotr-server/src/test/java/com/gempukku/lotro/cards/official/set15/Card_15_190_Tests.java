...
public class Card_15_190_Tests
{
	...
	public void EastWallofRohanStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* Type: site
		* Subtype: 
		* Game Text: At the start of the fellowship phase, you may exert two hunter companions to play a hunter companion from your draw deck.
		*/
