...
public class Card_07_152_Tests
{
	...
	//@Test
	public void MmakCommanderStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
	...
	//@Test
	public void MmakCommanderTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
