...
public class Card_17_007_ErrataTests
{
	...
	public void ElvenGuardianStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* 	<b>Hunter 1.</b> <i>(While skirmishing a non-hunter character, this character is strength +1.)</i><br>While this companion is skirmishing a wounded minion, he is strength +2.<br><b>Maneuver:</b> Exert this companion to heal another hunter.
		*/
		...
		assertEquals("Elven Guardian", card.getBlueprint().getTitle());
