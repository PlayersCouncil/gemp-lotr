...
public class Card_V3_069_ErrataTests
{
	...
	public void NoManMayHinderMeStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		 ...
		 * Type: Event
		 * Subtype: Skirmish
		 * Game Text: <b>Maneuver</b> <i>or</i> <b>Skirmish</b>: Restore a Nazgul. Then you may exert The Witch-king twice to hinder all Free Peoples possessions.
		*/
	...
	//@Test
	public void NoManMayHinderMeTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
