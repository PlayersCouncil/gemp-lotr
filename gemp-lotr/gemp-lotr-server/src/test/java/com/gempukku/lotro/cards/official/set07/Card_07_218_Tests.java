...
public class Card_07_218_Tests
{
	...
	//@Test
	public void lairOtsaStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {

		/**
		* Set: 7
		* Title: Úlairë Otsëa, Black-Mantled Wraith
		* Unique: True
		* Side: SHADOW
		* Culture: Wraith
		* Twilight Cost: 4
	...
	//@Test
	public void lairOtsaTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
