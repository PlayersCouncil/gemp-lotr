...
public class Card_07_104_Tests
{
	...
	@Test
	public void HiddenKnowledgeStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		assertEquals("Hidden Knowledge", card.getBlueprint().getTitle());
	...
	//@Test
	public void HiddenKnowledgeTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
