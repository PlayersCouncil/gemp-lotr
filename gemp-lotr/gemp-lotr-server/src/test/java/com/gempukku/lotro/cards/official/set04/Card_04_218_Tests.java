...
public class Card_04_218_Tests
{
	...
	@Test
	public void DesertLegionStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		assertEquals("Desert Legion", card.getBlueprint().getTitle());
	...
	//@Test
	public void DesertLegionTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
