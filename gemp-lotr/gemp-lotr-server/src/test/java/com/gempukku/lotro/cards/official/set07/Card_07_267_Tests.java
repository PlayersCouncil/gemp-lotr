...
public class Card_07_267_Tests
{
	...
	@Test
	public void DinofArmsStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		assertEquals("Din of Arms", card.getBlueprint().getTitle());
	...
	//@Test
	public void DinofArmsTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
