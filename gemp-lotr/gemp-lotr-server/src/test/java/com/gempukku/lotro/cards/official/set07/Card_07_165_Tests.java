...
public class Card_07_165_Tests
{
	...
	@Test
	public void SouthronIntruderStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {

		/**
		 * Set: 7
		 * Name: Southron Intruder
		 * Unique: False
		 * Side: Shadow
		 * Culture: Raider
		 * Twilight Cost: 6
		...
		*/
		...
		assertEquals("Southron Intruder", card.getBlueprint().getTitle());
	...
	//@Test
	public void SouthronIntruderTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
