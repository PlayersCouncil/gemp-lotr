...
public class Card_02_085_ErrataTests
{
	...
	public void TheWitchkingStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		/**
		 * Set: 2
		 * Name: The Witch-king, Lord of the Nazgul
		 * Unique: True
		 * Side: Shadow
		 * Culture: Wraith
		 * Twilight Cost: 8
		 ...
		 * Vitality: 4
		 * Site Number: 3
		 * Game Text: <b>Twilight</b>.<br>Return to Its Master cannot be played. Skirmishes involving The Witch-king cannot be canceled.<br>Each time The Witch-king wins a skirmish, you may exert him to wound the Ring-bearer twice.
		*/
		...
		assertEquals("Lord of the Nazgul", card.getBlueprint().getSubtitle());
