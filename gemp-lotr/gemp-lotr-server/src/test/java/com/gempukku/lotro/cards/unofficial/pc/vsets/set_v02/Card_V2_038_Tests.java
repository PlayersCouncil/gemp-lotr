...
public class Card_V2_038_Tests
{
	...
	public void TheBalrogStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		/**
		* Set: V2
		* Title: The Balrog, Lieutenant of Morgoth
		* Unique: True
		* Side: SHADOW
		* Culture: Moria_balrog
		* Twilight Cost: 14
		* Type: minion
		* Subtype: Balrog
		* Strength: 17
		...
		* 	Each time the Free Peoples player uses a skirmish special ability during a skirmish involving the Balrog, you may exert a companion it is skirmishing.
		*/
