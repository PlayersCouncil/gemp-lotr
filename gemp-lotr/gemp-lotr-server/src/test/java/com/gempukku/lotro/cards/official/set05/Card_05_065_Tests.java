...
public class Card_05_065_Tests
{
	...
	@Test
	public void WargStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		assertEquals("Warg", card.getBlueprint().getTitle());
	...
	//@Test
	public void WargTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
