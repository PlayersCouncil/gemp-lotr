...
public class Card_13_020_Tests
{
	...
	//@Test
	public void LrienProtectorStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
	...
	//@Test
	public void LrienProtectorTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
