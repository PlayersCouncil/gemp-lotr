...
public class Card_V2_010_Tests
{
	...
	public void DeadlyContestStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		 ...
		 * Type: Event
		 * Subtype: Maneuver
		 * Game Text: Spot an [elven] companion to reinforce a [dwarven] token or spot a [dwarven] companion to reinforce an [elven] token. If you can spot both Legolas and Gimli you may reinforce both an [elven] and [dwarven] token an additional time.  
		*/
