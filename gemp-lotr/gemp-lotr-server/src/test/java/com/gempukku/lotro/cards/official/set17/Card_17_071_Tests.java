...
public class Card_17_071_Tests
{
	...
	//@Test
	public void GrishnkhStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {

		/**
		* Set: 17
		* Title: Grishnákh, Treacherous Captain
		* Unique: True
		* Side: SHADOW
		* Culture: Orc
		* Twilight Cost: 4
	...
	//@Test
	public void GrishnkhTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
