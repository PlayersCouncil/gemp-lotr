...
public class Card_13_184_Tests
{
	...
	public void lairNertaStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		/**
		* Set: 13
		* Title: Úlairë Nertëa, Servant of the Shadow
		* Unique: True
		* Side: SHADOW
		* Culture: Wraith
		* Twilight Cost: 4
		...
		* Vitality: 2
		* Site Number: 3
		* Game Text: <b>Fierce</b>.<br>While you can spot a companion who has resistance 3 or less, Úlairë Nertëa is twilight cost -2.
		*/
