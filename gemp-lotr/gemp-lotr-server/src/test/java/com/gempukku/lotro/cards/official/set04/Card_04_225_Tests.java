...
public class Card_04_225_Tests
{
	...
	@Test
	public void EasterlingCaptainStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		assertEquals("Easterling Captain", card.getBlueprint().getTitle());
	...
	//@Test
	public void EasterlingCaptainTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
