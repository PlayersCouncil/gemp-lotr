...
public class Card_19_013_Tests
{
	...
	public void BoromirStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		 ...
		 * Vitality: 3
		 * Resistance: 5
		 * Game Text: <b>Fellowship</b>. <b>Ranger</b>.<br>While you can spot two unbound Hobbits, Boromir's twilight cost is -1.<br>Each time Boromir wins a skirmish, you may exert an unbound Hobbit to discard each minion he is skirmishing from play.
		*/
		...
		assertEquals("Destined Guide", card.getBlueprint().getSubtitle());
