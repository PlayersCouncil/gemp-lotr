...
public class Card_15_059_Tests
{
	...
	//@Test
	public void DnedainoftheSouthStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
	...
	//@Test
	public void DnedainoftheSouthTest1() throws DecisionResultInvalidException, CardNotFoundException {
		//Pre-game setup
		var scn = GetScenario();
