...
public class Card_04_086_ErrataTests
{
	...
	public void ThonnasStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* 	To play, spot an Elf. <br>While Thónnas bears a ranged weapon, each minion skirmishing him is strength -2 and Thónnas does not add to the fellowship archery total.
		*/
