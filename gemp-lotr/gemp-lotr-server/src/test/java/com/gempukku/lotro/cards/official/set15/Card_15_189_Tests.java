...
public class Card_15_189_Tests
{
	...
	public void CityGatesStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* Type: site
		* Subtype: 
		* Game Text: When the Fellowship moves to this site, add a threat (or 2 if you can spot a hunter minion) for each companion over 4.
		*/
