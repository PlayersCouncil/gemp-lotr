...
public class Card_V3_032_Tests
{
	...
	public void NorthernSignalfireStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		/**
		 * Set: V3
		 * Name: Northern Signal-fire, Beacon of Eilenach
		 * Unique: 2
		 * Side: Free Peoples
		 * Culture: Gondor
		 * Twilight Cost: 2
		...
		* 	While you can spot a [gondor] companion, valiant companions gain <b>knight</b>.
		* 	Each time you play a fortification, you may play a mount from your discard pile.
		*/
		...
		assertEquals("Beacon of Eilenach", card.getBlueprint().getSubtitle());
