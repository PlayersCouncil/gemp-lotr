...
public class Card_15_005_Tests
{
	...
	public void GimliStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		 ...
		 * Vitality: 3
		 * Resistance: 6
		 * Game Text: <b>Damage +1</b>. <b>Hunter 3</b>. <helper>(While skirmishing a non-hunter character, this character is strength +3.)</helper>
		*/
		...
		assertEquals("Eager Hunter", card.getBlueprint().getSubtitle());
