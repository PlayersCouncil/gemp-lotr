...
public class DiscardFromPlayTrainer implements Trainer {
    private static final String DISCARD = "discard";
    private static final String PLAY_ZONE = Zone.FREE_CHARACTERS.getHumanReadable();
    ...
    public boolean isStepRelevant(LearningStep step) {
        return step.decision.getDecisionType() == AwaitingDecisionType.CARD_SELECTION
                ...
                && csa.getZoneString().equals(PLAY_ZONE);
    }

    @Override
    public boolean equals(Object obj) {
        return obj.getClass().equals(DiscardFromPlayTrainer.class);
    }
}
