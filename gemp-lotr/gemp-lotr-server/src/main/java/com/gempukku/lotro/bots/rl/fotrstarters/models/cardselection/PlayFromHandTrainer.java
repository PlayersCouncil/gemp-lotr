...
public class PlayFromHandTrainer implements Trainer {
    private static final String PLAY_FROM_HAND = "play from hand";
    ...
    public boolean isStepRelevant(LearningStep step) {
        return step.decision.getDecisionType() == AwaitingDecisionType.CARD_SELECTION
                && step.decision.getText().toLowerCase().contains(PLAY_FROM_HAND)
                && step.action instanceof CardSelectionAction;
    }

    @Override
    public boolean equals(Object obj) {
        return obj.getClass().equals(PlayFromHandTrainer.class);
    }
