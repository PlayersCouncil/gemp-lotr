...
public class TttTableDraftBoosterProducer implements BoosterProducer {
    ...
    private static final String TTT_FILTER = "set:4";
    private static final String BOHD_FILTER = "set:5";
    private static final String EOF_FILTER = "set:6";
    ...
    public TttTableDraftBoosterProducer(CollectionsManager collectionsManager, LotroCardBlueprintLibrary cardLibrary,
        ...
        List<String> sets = List.of("ttt", "bohd", "eof");
        ...
        for (String set : sets) {
            for (String rarity : rarities) {
                for (String type : types) {
                    ...
                    cardPools.get(key).removeIf(s -> !s.startsWith((sets.indexOf(set) + 4) + "_")); // Allowed numbers 4, 5 and 6
                }
            }
        }
        ...
        cardPools.get("rare-ttt-fp").add("4_1");
    }
