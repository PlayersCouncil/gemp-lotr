...
public class AttachItemTrainer implements Trainer {
    private static final String ATTACH = "Choose target to attach to";
    ...
    public boolean isStepRelevant(LearningStep step) {
        return step.decision.getDecisionType() == AwaitingDecisionType.CARD_SELECTION
                && step.decision.getText().contains(ATTACH)
                && step.action instanceof CardSelectionAction;
    }

    @Override
    public boolean equals(Object obj) {
        return obj.getClass().equals(AttachItemTrainer.class);
    }
}
