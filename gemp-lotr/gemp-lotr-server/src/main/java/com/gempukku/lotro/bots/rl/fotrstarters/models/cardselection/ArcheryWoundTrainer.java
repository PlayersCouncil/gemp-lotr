...
public class ArcheryWoundTrainer implements Trainer {
    private static final String ARCHERY = "assign archery wound to";
    ...
    public boolean isStepRelevant(LearningStep step) {
        return step.decision.getDecisionType() == AwaitingDecisionType.CARD_SELECTION
                && step.decision.getText().contains(ARCHERY)
                && step.action instanceof CardSelectionAction;
    }

    @Override
    public boolean equals(Object obj) {
        return obj.getClass().equals(ArcheryWoundTrainer.class);
    }
}
