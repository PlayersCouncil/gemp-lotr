...
public class MulliganTrainer implements Trainer {
    private static final String MULLIGAN = "mulligan";
    ...
    public boolean isStepRelevant(LearningStep step) {
        if (step.decision.getDecisionType() == AwaitingDecisionType.MULTIPLE_CHOICE) {
            return step.decision.getText().contains(MULLIGAN) && step.action instanceof MultipleChoiceAction;
        }
        return false;
    }
    ...
    public boolean equals(Object obj) {
        return obj.getClass().equals(MulliganTrainer.class);
    }
}
