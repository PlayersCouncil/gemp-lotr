...
public class HealTrainer implements Trainer {
    private static final String HEAL = "to heal";
    ...
    public boolean isStepRelevant(LearningStep step) {
        return step.decision.getDecisionType() == AwaitingDecisionType.CARD_SELECTION
                && step.decision.getText().contains(HEAL)
    ...
    public boolean equals(Object obj) {
        return obj.getClass().equals(HealTrainer.class);
    }
}
